...
RUN curl -fsSL "https://github.com/likecyber/qbittorrent-ut-nox-static/releases/download/${FULL_VERSION_LIB1}/aarch64-qbittorrent-nox" > "${APP_DIR}/qbittorrent-nox-lib1" && \
    chmod 755 "${APP_DIR}/qbittorrent-nox-lib1" && \
    curl -fsSL "https://github.com/likecyber/qbittorrent-ut-nox-static/releases/download/${FULL_VERSION_LIB2}/aarch64-qbittorrent-nox" > "${APP_DIR}/qbittorrent-nox-lib2" && \
